...
module.exports = __webpack_require__(/*! E:\WorkFolder\cursos\udemy\NET.5.0\ProEventos\front\proeventos-app\src\main.ts */"zUnb");
...
PalestrantesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PalestrantesComponent, selectors: [["app-palestrantes"]], decls: 3, vars: 0, template: function PalestrantesComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "Palestrantes de Component");
...
class AppComponent {
    constructor() {
        this.title = 'ProEventos Angular Aplication';
    }
}
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 7, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "Palestrantes");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](5, "app-palestrantes");
...
function EventosComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"](" ", evento_r1.tema, " ", evento_r1.local, " ");
} }
class EventosComponent {
    ...
    getEventos() {
        this.http.get("https://localhost:5001/api/Eventos").subscribe(Response => this.eventos = Response, erro => console.log(erro));
    }
}
...
EventosComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: EventosComponent, selectors: [["app-eventos"]], decls: 3, vars: 1, consts: [[4, "ngFor", "ngForOf"]], template: function EventosComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](2, EventosComponent_div_2_Template, 3, 2, "div", 0);
    } if (rf & 2) {
